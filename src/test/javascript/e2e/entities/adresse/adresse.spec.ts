...
describe('Adresse e2e test', () => {
    ...
    it('should load Adresses', async () => {
        ...
        expect(await adresseComponentsPage.getTitle()).to.eq('jhipsterSampleApplicationApp.adresse.home.title');
    });
    ...
    it('should load create Adresse page', async () => {
        ...
        expect(await adresseUpdatePage.getPageTitle()).to.eq('jhipsterSampleApplicationApp.adresse.home.createOrEditLabel');
    ...
    it('should create and save Adresses', async () => {
        ...
        await adresseComponentsPage.clickOnCreateButton();
        await promise.all([
            adresseUpdatePage.setNumeroInput('5'),
        ...
        expect(await adresseUpdatePage.getNumeroInput()).to.eq('5');
        expect(await adresseUpdatePage.getRueInput()).to.eq('rue');
        expect(await adresseUpdatePage.getCodePostalInput()).to.eq('codePostal');
    ...
    it('should delete last Adresse', async () => {
        ...
        expect(await adresseDeleteDialog.getDialogTitle()).to.eq('jhipsterSampleApplicationApp.adresse.delete.question');
