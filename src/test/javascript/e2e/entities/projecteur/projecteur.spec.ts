...
describe('Projecteur e2e test', () => {
    ...
    it('should load Projecteurs', async () => {
        ...
        expect(await projecteurComponentsPage.getTitle()).to.eq('jhipsterSampleApplicationApp.projecteur.home.title');
    });
    ...
    it('should load create Projecteur page', async () => {
        ...
        expect(await projecteurUpdatePage.getPageTitle()).to.eq('jhipsterSampleApplicationApp.projecteur.home.createOrEditLabel');
    ...
    it('should delete last Projecteur', async () => {
        ...
        expect(await projecteurDeleteDialog.getDialogTitle()).to.eq('jhipsterSampleApplicationApp.projecteur.delete.question');
