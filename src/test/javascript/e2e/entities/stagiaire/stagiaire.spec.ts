...
describe('Stagiaire e2e test', () => {
    ...
    it('should load Stagiaires', async () => {
        ...
        expect(await stagiaireComponentsPage.getTitle()).to.eq('jhipsterSampleApplicationApp.stagiaire.home.title');
    });
    ...
    it('should load create Stagiaire page', async () => {
        ...
        expect(await stagiaireUpdatePage.getPageTitle()).to.eq('jhipsterSampleApplicationApp.stagiaire.home.createOrEditLabel');
    ...
    it('should delete last Stagiaire', async () => {
        ...
        expect(await stagiaireDeleteDialog.getDialogTitle()).to.eq('jhipsterSampleApplicationApp.stagiaire.delete.question');
