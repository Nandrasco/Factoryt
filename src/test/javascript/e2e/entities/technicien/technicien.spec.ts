...
describe('Technicien e2e test', () => {
    ...
    it('should load Techniciens', async () => {
        ...
        expect(await technicienComponentsPage.getTitle()).to.eq('jhipsterSampleApplicationApp.technicien.home.title');
    });
    ...
    it('should load create Technicien page', async () => {
        ...
        expect(await technicienUpdatePage.getPageTitle()).to.eq('jhipsterSampleApplicationApp.technicien.home.createOrEditLabel');
    ...
    it('should delete last Technicien', async () => {
        ...
        expect(await technicienDeleteDialog.getDialogTitle()).to.eq('jhipsterSampleApplicationApp.technicien.delete.question');
