...
describe('Gestionnaire e2e test', () => {
    ...
    it('should load Gestionnaires', async () => {
        ...
        expect(await gestionnaireComponentsPage.getTitle()).to.eq('jhipsterSampleApplicationApp.gestionnaire.home.title');
    });
    ...
    it('should load create Gestionnaire page', async () => {
        ...
        expect(await gestionnaireUpdatePage.getPageTitle()).to.eq('jhipsterSampleApplicationApp.gestionnaire.home.createOrEditLabel');
    ...
    it('should delete last Gestionnaire', async () => {
        ...
        expect(await gestionnaireDeleteDialog.getDialogTitle()).to.eq('jhipsterSampleApplicationApp.gestionnaire.delete.question');
