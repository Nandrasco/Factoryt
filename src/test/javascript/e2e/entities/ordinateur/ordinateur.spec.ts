...
describe('Ordinateur e2e test', () => {
    ...
    it('should load Ordinateurs', async () => {
        ...
        expect(await ordinateurComponentsPage.getTitle()).to.eq('jhipsterSampleApplicationApp.ordinateur.home.title');
    });
    ...
    it('should load create Ordinateur page', async () => {
        ...
        expect(await ordinateurUpdatePage.getPageTitle()).to.eq('jhipsterSampleApplicationApp.ordinateur.home.createOrEditLabel');
    ...
    it('should create and save Ordinateurs', async () => {
        ...
        const selectedDispo = ordinateurUpdatePage.getDispoInput();
        if (await selectedDispo.isSelected()) {
            await ordinateurUpdatePage.getDispoInput().click();
            expect(await ordinateurUpdatePage.getDispoInput().isSelected()).to.be.false;
        } else {
            await ordinateurUpdatePage.getDispoInput().click();
    ...
    it('should delete last Ordinateur', async () => {
        ...
        expect(await ordinateurDeleteDialog.getDialogTitle()).to.eq('jhipsterSampleApplicationApp.ordinateur.delete.question');
